...
//*
//*purpuse:    allocate a socket and then repeatedly execute the following:
...
//                   1.client will sends the data ,server recv the data in an array and store this array in a file which will be open in write mode on client side...
                      
//                 ** if any  client  wants to download a video then server checks in the common storage and if video is present then server will send the video to the client side  
...
// &yes zero is false, and non-zero is true. And that's an absolute fact...................................,
// sizeof(int) defines the size ..................................................................
// Returns zero on success, or -1 on error
/****************************************************************************************************************************************************************/

            if ((sockfd = socket(servinfo->ai_family, servinfo->ai_socktype,servinfo->ai_protocol)) == -1)  /*********** creat a server socket ************/
       	    {
...
/*******************************************************************************************************************************************************/           
     ...
     //this function does not return any vakue.............................................................................................
/**********************************************************************************************************************************************************/
...
/***********************************************************************************************************************************************************/
  ...
  //sa.sa_handler = sigchld_handler; sa_handler  specifies  the  action  to be associated with signum .this function receives the signal number as its only argument
...
/***************************************************************************************************************************************************************/
  ...
  // &sa If act is non-null, the new action for signal signum is installed from act.  If oldact is non-null, the previous action is saved in oldact.
...
/**********************************************************************************************************************************************************/
  ...
  /*****************************************************************************************************************************************************************/
/*fork creates  a new process by duplicating the calling process.the new process, referred to as the child, is an  exact duplicate  the   calling  process,  referred  to as the parent...................................*/
/***************************************************************************************************************************************************************/
                ...
                do
                {
                             ...
                             while(flag2==1)
			     {
					 ...
					 if(fread(&user,sizeof(user),1,f1)==1)        
                                         {
				               if(strcmp(user.recv_video_name1,v_name)==0)  //compare the video name and recv video name is same or not 
				               { 
